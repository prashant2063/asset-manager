<?php
  ...
  $pagetitle ="Dashboard";
	...
	if(isset($_GET['Inventory_Date'])){
		...
		$Electronics = $user->countTotalAssetByType($Year, "Electronics");
	  $Equipment = $user->countTotalAssetByType($Year, "Equipment");
	  $Furniture = $user->countTotalAssetByType($Year, "Furniture");
	  $Software = $user->countTotalAssetByType($Year, "Software");
	  $Machinery = $user->countTotalAssetByType($Year, "Machinery");
	  $Miscalleneous = $user->countTotalAssetByType($Year, "Miscalleneous");
	}else {
												...
												<div class="widget-main no-padding">
													<table class="table table-bordered table-striped">
														...
														<?php
															...
															$query = "SELECT new_licence.Name, assetlicences.AssetID,assigneditems.OfficeName, assetlicences.DateInstalled as DateInstalled, new_licence.Period,DATEDIFF( DateInstalled, '$form') as Days FROM new_licence,assetlicences,assigneditems WHERE new_licence.SerialNumber = assetlicences.LicenceID AND assetlicences.AssetID = assigneditems.SerialNumber ORDER BY Days ASC LIMIT 7";
															...
															<tr>
																...
																<td class="hidden-480">
																	<?php
																	if($row['Days']>0){
																		echo '<span class="label label-success arrowed-right arrowed-in">Valid '.$row['Days'].' days remaining</span>';
																	}else {
																		echo '<span class="label label-warning arrowed-right arrowed-in">Expired '.($row['Days']*-1).' days ago</span>';
																	}
																	 ?>
																...
																<div class="inline dropdown-hover">
																	...
																	<?php
																	  ...
																	  $stmt = $db->prepare($query);
																		...
																		?>
																			<option value="">  </option>
																			<option value="<?php echo $row['DateAdded'];?>" <?php if(isset($_GET['DateAdded'])){if($row['DateAdded']==$_GET['Inventory_Date']){echo "selected = 'true'";}} ?>> <?php echo $row['DateAdded'];?> </option>
																		<?php
																		}
																		 ?>
																	</select>
														...
														<div class="widget-body">
															<div class="widget-main">
																...
																<div class="clearfix">
																	<div class="grid3">
																		<span class="grey">
																			<i class="ace-icon fa fa-desktop fa-2x blue"></i>
																			&nbsp; Total Assets
																		</span>
																		<h4 class="bigger pull-right" id="TotalAssets"> <?php if(isset($TotalAssets)){echo $TotalAssets;} ?>  </h4>
																	</div>

																	<div class="grid3">
																		<span class="grey">
																			<i class="ace-icon fa fa-info-circle fa-2x red"></i>
																			&nbsp; Untraceable
																		</span>
																		<h4 class="bigger pull-right" id="Untraceable"> <?php if(isset($TotalUntraceable)){echo $TotalUntraceable;} ?> </h4>
																	</div>

																	<div class="grid3">
																		<span class="grey">
																			<i class="ace-icon fa fa-suitcase fa-2x purple"></i>
																			&nbsp; In Store
																		</span>
																		<h4 class="bigger pull-right" id="InStore">  <?php if(isset($TotalStore)){ echo $TotalStore;} ?>  </h4>
																	</div>
																</div>
															</div><!-- /.widget-main -->
														</div><!-- /.widget-body -->
														...
														<tbody>
														  ...
														  $stmt->execute();
															...
															<tr>
																...
																<td><?php if( $row['Status']=="N"){echo "<span class='label label-sm label-warning'>Unconfirmed Account</span>";}else if( $row['Status']=="Y") { echo "<span class='label label-sm label-success'>Confirmed Account</span>";} else { {echo "<span class='label label-sm label-warning'>Pending Approval</span>";} }?></td>
																			...
																			<div class="col-xs-12 col-sm-10">
																				...
																				<div class="profile-user-info profile-user-info-striped">
																					...
																					<div class="profile-info-row">
																						...
																						<div class="profile-info-value">
																							<span><?php echo $user->countItemsIncharge($row['PayrollNumber']); ?></span>
																						</div>
																					</div>
																				</div>
																			</div>
