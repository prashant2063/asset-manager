					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">&copy; NITH</h4>
							</div>
                          ...
                          // check if email or payroll number already enchant_broker_dict_exists
                            if(!$user->EmailExists($user_email)){
                              if(!$user->PayrollExists($user_payroll)){
                                ...
                                $stmt = $db->prepare('INSERT INTO profilemaster(PayrollNumber, Name, Email, Username, PhoneNumber, Password, Photo, Office, Department, OfficeTelephone, Role, Status, tokenCode, DateAdded) VALUES (:PayrollNumber, :Name, :Email, :Username, :PhoneNumber, :Password, :Photo, :Office, :Department, :OfficeTelephone, :Role, :Status, :tokenCode, :DateAdded)');
				            	...
				            	?>
											...
											<form id="registration-form" method="post" action="">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Payroll Number" name="PayrollNumber" required min='4' pattern='^[0-9]{4}$' title='4 or moreNumbers only' id="PayrollNumber" value='<?php if(isset($errMSG)){ echo $_POST['PayrollNumber'];}?>'/>
