															...
															<div class="row">
																<div class="tabbable">
																	<ul class="nav nav-tabs" id="myTab">
																		...
																		<li>
																			<a data-toggle="tab" href="#licences">
																	...
																	<div class="tab-content">
																		...
																		<div id="finance" class="tab-pane fade">
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="PurchasePrice" id="PurchasePrice" class="col-xs-12 col-sm-6" value="<?php echo $row['PurchasePrice']; ?>" />
																					</div>
																				</div>
																			</div>
																			<div class="form-group">
																				<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="ScrapValue">Scrap value:</label>

																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="ScrapValue" id="ScrapValue" class="col-xs-12 col-sm-6" value="<?php echo $row['ScrapValue']; ?>" />
																					</div>
																				</div>
																			</div>
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="ExpectedLife" id="ExpectedLife" class="col-xs-12 col-sm-6" value="<?php echo $row['ExpectedAssetLife']; ?>" />
																					</div>
																				</div>
																			</div>
																			...
																			<div class="form-group">
																				<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="state">Depreciation Method</label>
																				...
																				<div class="col-xs-12 col-sm-9">
																					<select id="DepreciationMethod" name="state" class="select2" data-placeholder="Click to Choose..." onchange="getData(this.value, 'displaydata')">
																						<option value=" "></option>
																						<option value="1">Sum of Years Depreciation</option>
																						<option value="2">Doubling Declining balance</option>
																						<option value="3">Straight-line depreciation</option>
																		...
																		<div id="custodian" class="tab-pane fade">
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="ScrapValue" id="ScrapValue" class="col-xs-12 col-sm-6" value="<?php if($row['SerialNumber']=="N/A"){echo $user->getCustodian($row['AssetNumber']);}else{echo $user->getCustodian($row['SerialNumber']);}  ?>" />
																					</div>
																				</div>
																			</div>
																		</div>
