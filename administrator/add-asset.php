												...
												<div class="step-content pos-rel">
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="general-information" method="get">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<select id="assetType" name="assetType" class="select2" data-placeholder="Click to Choose...">
																		<option value="">&nbsp;</option>
																		<<?php
																			$stmt = $db->query('SELECT Name FROM asset_type ORDER BY Name DESC');
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="assetBrand">Brand:</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetBrand" id="assetBrand" class="col-xs-12 col-sm-4" />
																	</div>
																</div>
															</div>
													...
													<div class="step-pane" data-step="2">
														...
														<form class="form-horizontal" id="asset-information" method="get">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetNumber" id="assetNumber" class="col-xs-12 col-sm-4" />
																	</div>
																</div>
															</div>
													...
													<div class="step-pane" data-step="3">
														...
														<form class="form-horizontal" id="finance-information" method="get">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetPurchasePrice" pattern ="[0-9]*" minlength = '5' maxlength = '10' id="assetPurchasePrice" class="col-xs-12 col-sm-4" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="ExpectedAssetLife" pattern ="[0-9]*" minlength = '2' maxlength = '10'  id="ExpectedAssetLife" class="col-xs-12 col-sm-4" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="assetScrapValue">Scrap Value:</label>
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetScrapValue" pattern ="[0-9]*" minlength = '5' maxlength = '10'  id="assetScrapValue" class="col-xs-12 col-sm-4" />
																	</div>
																</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
				  ...
				  {
				    assetType: $('[name=assetType]').val(), assetManufacturer: $('[name=assetManufacturer]').val(), assetBrand:  $('[name=assetBrand]').val(),
