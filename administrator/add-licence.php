		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
				  ...
				  {
				    LicenceName: $('[name=LicenceName]').val(), LicenceVendor: $('[name=LicenceVendor]').val(), ActivationCode:  $('[name=ActivationCode]').val(), LicenceSlots:  $('[name=LicenceSlots]').val(), LicenceValidity:  $('[name=LicenceValidity]').val(), reusable:  $('input[name=reusable]:checked').val()
				  },
				  function(data){
						bootbox.dialog({
							message: data,
