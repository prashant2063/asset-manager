														...
														<form class="form-horizontal" id="validation-form" method="get">
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="TechnicianNumber" name="TechnicianNumber" class="col-xs-12 col-sm-5" value="WPC/ICT/VENDOR/<?php echo $user->getLastRecord('new_technicianr'); ?>" disabled />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="TechnicianName" name="TechnicianName" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					$.post('../custom/addTechnician.php',
					{
						TechnicianNumber: $('[name=TechnicianNumber]').val(), TechnicianName: $('[name=TechnicianName]').val(), TechnicianPhone: $('[name=phone]').val(), TechnicianEmail: $('[name=email]').val(), TechnicianTown: $('[name=Town]').val()
				  },
					function(data){
						bootbox.dialog({
							message: data,
