																...
																<div class="col-xs-12 col-sm-9">
																	<select id="Custodian" name="Custodian" class="select2" data-placeholder="Click to Choose...">
																		...
																		$SerialNum = $row_fechAsset['SerialNumber'];
																			...
																			{
																				?>
																				<option value="<?php echo $row['AssignedUser'];?>" <?php if( $row_fechAsset['Custodian']==$row['AssignedUser']){ echo "selected = 'true'";} ?>> <?php echo $user->getAssignedUserName($row['AssignedUser']);?></option>
																				<?php
																			}
																		 ?>
																	</select>
