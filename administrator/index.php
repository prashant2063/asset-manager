															...
															<tr>
																...
																<td>
																	<div class="hidden-sm hidden-xs btn-group">
																		<a class="btn btn-xs btn-success" title="Confirm this user account">
																			<i class="ace-icon fa fa-check bigger-120"></i>
																		</a>


																		<a class="btn btn-xs btn-danger delete_user" data-id="<?php echo $row['Id']; ?>" href="javascipt:void(0)">
																			<i class="ace-icon fa fa-trash-o bigger-120" title="Delete"></i>
																		</a>

																		<a class="btn btn-xs btn-warning" title="Suspend this user">
																		...
																		<div class="row">
																			<div class="col-xs-12 col-sm-2">
																				<div class="text-center">
																					<img height="150"  width ="268px" class="thumbnail inline no-margin-bottom" alt="<?php echo $row['Username']; ?>'s Avatar" src="data:image/jpeg;base64,<?php echo base64_encode( $row['Photo'] );?>" />
																					<br />
