                                              ...
                                              <h3 class="lighter block green">Your information</h3>
    																							...
    																							<form class="form-horizontal" id="validation-form" method="get" autocomplete='off'>
																										...
																										<div class="form-group">
																											<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="my_photo">Photo:</label>
																											<div class="col-xs-12 col-lg-3 col-md-3 col-sm-3">
																												<input type="file" id="my_photo" name="my_photo"  accept="image/*"/>
																											</div>
																										</div>
																										<div class="space-2"></div>
                                                              ...
                                                              <div class="col-xs-12 col-sm-9">
                                                                  <select id="Office" name="Office" class="select2" data-placeholder="Click to Choose...">
                                                                      <option value="">&nbsp;</option>
	              																														 ...
	              																														 {?>
																																								<option <?php if($fetchUserDetails['Office']==$row['OfficeName']){echo "selected ='true'";}  ?> value ="1" ><?php echo $row['OfficeName'];?></option>
																																							<?php
																																						 }?>
                                                                  </select>
                                                                </div>
...
$(document).ready(function()
{
 ...
 {
  var id=$(this).val();
  var dataString = 'ParentOffice='+ id;

  $.ajax
  ({
   type: "POST",
   url: "../custom/get_department.php",
   data: dataString,
   cache: false,
				 ...
				 callback: function() {
					 ...
					 $.post('../custom/update-profile.php',
					 {
						 'Name': $('[name=FullName]').val(), 'Email': $('[name=email]').val(), 'Username': $('[name=Username]').val(),
			 			 ...
			 			 'Department': $('[name=Department]').val(), 'OfficeTelephone': $('[name=OfficeTelephone]').val(), 'Photo': $('[name=my_photo]').val(),'uID': "<?php echo $fetchUserDetails['Id']; ?>"
				   })
