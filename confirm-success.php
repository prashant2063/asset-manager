...
if(isset($_GET['id']) && isset($_GET['code']))
{
                ...
                $stmt = $db->prepare("SELECT user_id,userStatus FROM table_users WHERE user_id=:uID AND tokenCode=:code LIMIT 1");
                ...
                if($stmt->rowCount() > 0)
                {
                  ...
                  {
                    $stmt = $db->prepare("UPDATE table_users SET userStatus=:status WHERE user_id=:uID");
