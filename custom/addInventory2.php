<?php
  ...
  $stmt = $db->prepare('INSERT INTO new_inventory (AssetNumber, AssetSerial, Status, AssetCondition, Custodian, Office, Department, Year, DateAdded, AddedBy) VALUES (:AssetNumber, :AssetSerial, :Status, :AssetCondition, :Custodian, :Office, :Department, :Year, :DateAdded, :AddedBy)') ;
