	...
	require('../func/config.php');
      $MethodId = $_GET['DepreciationMethod'];
	    ...
	    $row = $stmt->fetch();
			...
			//definitions
				// $AssetPurchasePrice = $user->getPurchasePrice($Assetid);
				//
				// $OriginalAssetCost = $user->getPurchasePrice($Assetid);
				//
				// $SalvageValue = $user->getSalvageValue($Assetid);
				//
				// $ExpectedLifespanInYears = $user->getAssetLife($Assetid);
