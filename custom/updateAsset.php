<?php
  ...
  $stmt = $db->prepare('UPDATE new_item SET Type=:Type,Manufacturer=:Manufacturer,Brand=:Brand,Model=:Model,SerialNumber=:SerialNumber,AssetNumber=:AssetNumber,AssetName=:AssetName,Status=:Status,AssetCondition=:AssetCondition,WarrantyExpiry=:WarrantyExpiry,Vendor=:Vendor,PurchasePrice=:PurchasePrice,ExpectedAssetLife=:ExpectedAssetLife,ScrapValue=:ScrapValue,PurchaseDate=:PurchaseDate,AddedBy=:AddedBy,DateAdded =:DateAdded WHERE Id=:Id') ;
