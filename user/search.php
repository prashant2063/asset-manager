										...
										<div class="col-xs-12 col-md-10 col-md-offset-1">
											<div class="search-area well no-margin-bottom">
												...
												<?php
													...
													$page_url           = "http://localhost/wpams/search";
													if(isset($_GET["page"]))
													...
													$stmt->bindValue(":search3", $search2, PDO::PARAM_STR);
													$stmt->bindValue(":search4", $search2, PDO::PARAM_STR);
													$stmt->bindValue(":search5", $search2, PDO::PARAM_STR);
													$stmt->bindValue(":search6", $search2, PDO::PARAM_STR);
													$stmt->bindValue(":search7", $search2, PDO::PARAM_STR);
													$stmt->execute();
													...
													if($stmt->rowCount() > 0)
													{
														...
														$stmt2 = $db->prepare("SELECT * FROM new_item WHERE Type LIKE :search1 OR Manufacturer LIKE :search2 OR Brand LIKE :search3 OR AssetName LIKE :search4 OR Model LIKE :search5 OR SerialNumber LIKE :search6 OR AssetNumber LIKE :search7");
														$stmt2->bindValue(":search1", $search1, PDO::PARAM_STR);
														$stmt2->bindValue(":search2", $search2, PDO::PARAM_STR);
														$stmt2->bindValue(":search3", $search2, PDO::PARAM_STR);
														$stmt2->bindValue(":search4", $search2, PDO::PARAM_STR);
														$stmt2->bindValue(":search5", $search2, PDO::PARAM_STR);
														$stmt2->bindValue(":search6", $search2, PDO::PARAM_STR);
														$stmt2->bindValue(":search7", $search2, PDO::PARAM_STR);
														$stmt2->execute();
										...
										if(isset($get_total_rows)){
											if($get_total_rows > $item_per_page ){
												...
												<div class='search-area well well-sm text-center'>
														<?php echo $user->paginateSearchResults($item_per_page, $page_number, $get_total_rows, $total_pages, $page_url);
														?>
												</div>
												<?php
											}
